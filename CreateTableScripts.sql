...
CREATE TABLE IF NOT EXISTS `mydb`.`Module` (
  ...
  `App_ID` INT NOT NULL COMMENT 'Modes will group requiremnents into logical blocks',
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`AppRules_filter` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`AppReqType` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Requirement` ;
...
CREATE TABLE IF NOT EXISTS `mydb`.`Requirement` (
  ...
  `Parent_AppRuleType_ID` INT NOT NULL,
  `Requirement_text` LONGTEXT NULL,
  ...
  INDEX `fk_Requirement_Requirement1_idx` (`Parent_Requirement_id` ASC, `Parent_AppRuleType_ID` ASC),
  ...
  CONSTRAINT `fk_Requirement_ApplicationRuleType1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Requirement_Requirement1`
    FOREIGN KEY (`Parent_Requirement_id` , `Parent_AppRuleType_ID`)
    REFERENCES `mydb`.`Requirement` (`Requirement_id` , `AppRuleType_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`Module_Reqiuremnet`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Module_Reqiuremnet` ;

CREATE TABLE IF NOT EXISTS `mydb`.`Module_Reqiuremnet` (
  `Module_ID` INT NOT NULL,
  `App_ID` INT NOT NULL,
  `Requirement_id` INT NOT NULL,
  PRIMARY KEY (`Module_ID`, `App_ID`, `Requirement_id`),
  INDEX `fk_Reqiuremnet_rulesgroup_RulesGroup1_idx` (`Module_ID` ASC, `App_ID` ASC),
  INDEX `fk_Reqiuremnet_rulesgroup_Requirement1_idx` (`Requirement_id` ASC),
  CONSTRAINT `fk_Reqiuremnet_rulesgroup_RulesGroup1`
    FOREIGN KEY (`Module_ID` , `App_ID`)
    REFERENCES `mydb`.`Module` (`Module_ID` , `App_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Code_Value` ;
...
-- Table `mydb`.`Literal`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`Literal` ;
